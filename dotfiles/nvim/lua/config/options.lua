...
opt.scrolloff = 6 -- keep 10 lines above/below cursor
...
opt.colorcolumn = "100" -- show a column at 100 position characters
...
opt.splitright = true -- vertival splits go right
...
vim.g.netrw_winsize = 25 -- explorer takes 25% width
